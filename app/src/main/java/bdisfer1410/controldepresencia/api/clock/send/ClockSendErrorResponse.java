...
public class ClockSendErrorResponse {
    private static final String ERROR_KEYNAME_SUFFIX = "clock_error_sendservice_";
    private final String error;
    @SerializedName("msg")
    private final String tokenError;

    public ClockSendErrorResponse(String error, String tokenError) {
        this.error = error;
